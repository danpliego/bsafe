<div class="wrapper">
      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <div class="collapse" id="collapseAbout">
            ...
            <p>
              Es esta filosofia de trabajo que te invitamos a conocer en nuestras oficinas.
            </p>
            <div class="img-container visible-xs">
              <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/car.png">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="section">
        <div class="container">
          ...
          <div class="col-sm-4 col-xs-6 text-center level">
            <div class="wrapper">
              <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/level-1.png">
              <h4>
                NIVEL 1:
              </h4>
              <p>
  ...
  <div id="contacto" class="sect">
    ...
    <div class="contact-content">
      ...
      <a class="toggle-collapse visible-xs" role="button" data-toggle="collapse" href="#collapseContact" aria-expanded="false" aria-controls="collapseContact">
        <i class="fa fa-chevron-down closed"></i>
        <i class="fa fa-chevron-up open"></i>
      </a>
